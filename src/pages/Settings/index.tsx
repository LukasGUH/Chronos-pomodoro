...
export function Settings() {
    ...
    function handleSaveSettings(e: React.FormEvent<HTMLFormElement>) {
        ...
        if (workTime < 1 || workTime > 99) {
            formErrors.push("O tempo de foco deve ser um valor entre 1 e 99")
        }

        if (shortBreakTime < 1 || shortBreakTime > 30) {
            formErrors.push("O tempo de descanso curto deve ser um valor entre 1 e 30")
        }

        if (longBreakTime < 1 || longBreakTime > 60) {
            formErrors.push("O tempo de descanso longo deve ser um valor entre 1 e 60")
        }
